...
function PricingCard({ title, desc, price, options }) {
  return (
    <Card variant="gradient" color="blue" className="rounded-lg border-black">
      <CardHeader
        floated={false}
        shadow={false}
        color="transparent"
      ...
      <CardBody className="pt-0">
        ...
        <button className="items-center w-[80%] py-2 bg-zinc-800 rounded-md text-white">
          get started
        </button>
        </div>
      </CardBody>
...
export function PricingSection11() {
  ...
  return (
    <section className="py-24 px-8 text-black flex justify-center">
      <div className="container mx-auto">
        ...
        <div className="w-full flex justify-center">
        <div className="grid gap-x-10 gap-y-8 md:grid-cols-2 lg:grid-cols-3 w-[75%]">
